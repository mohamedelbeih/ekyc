...
def detect_class_process(json_file_path,user_id):
    ...
    initialize_model("../Data/Models/"+user_id,"card_detect_class/recognition")
    result: dict = process_docs_in_image(user_id,**validated_data)
    deinitialize_model("../Data/Models/"+user_id,"card_detect_class/recognition")
    return result
    
results = detect_class_process(sys.argv[1],user_id)
with open("../Data/Processing_results/"+user_id+".json","w") as f:
